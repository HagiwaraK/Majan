class Calculate
	...
	def TotalScore game, hand, user1, user2, user3, user4
		#@oya_person = 
		#@agari_person1 = 
		#@agari_person2 = 
		#@furikomi_person =
	...
	def GetHanHuPoint hand
		if ron_flag || tumo_flag then
			#han1 =
			#hu1 =
			if @agari_person1 == @oya_person then
				OyaTumo(han1, hu1, @agari_person1) if tumo_flag
				OyaRon(han1, hu1, @agari_person1) if ron_flag
			else
				KoTumo(han1, hu1, @agari_person1) if tumo_flag
				KoRon(han1, hu1, @agari_person1) if ron_flag
			end
		elsif double_ron_flag then
			#han1 = 
			#hu1 = 
			...
			if @agari_person2 == @oya_person then
				OyaTumo(han2, hu2, @agari_person2) if tumo_flag
				OyaRon(han2, hu2, @agari_person2) if ron_flag
			else
				KoTumo(han2, hu2, @agari_person2) if tumo_flag
				KoRon(han2, hu2, @agari_person2) if ron_flag
			end
		elsif drawn_flag then
			#break
		end
